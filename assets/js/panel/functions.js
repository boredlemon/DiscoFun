...
function updateChannel() {
  ...
  if (guilds.val() === 'DM') {
    ...
    document.title = `#${escapeHtml(user.username)} - DiscoFun`;
    ...
    document.title = `#${escapeHtml(channel.name)} - DiscoFun`;
...
function updateGuild() {
  ...
  if (guilds.val() === 'DM') {
    ...
    guildName.html(
        ...
        }" target="_blank"><img alt="" src="${guild.iconURL() || 'assets/images/discord_defaults_avatars/wojak.jpg'
